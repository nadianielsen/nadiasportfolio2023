...
const GalleryCards = ({img, headline, text}) => {
    return ( 
        <div className="bg-white w-[20rem] h-[25rem] rounded-2xl gallery-card-shadow relative">
                <img src={img} alt="" className="object-cover absolute w-full h-full rounded-2xl"/>
            <div className="w-full h-[10rem] bg-white absolute bottom-0 rounded-xl grid grid-rows-2 gallery-card">
