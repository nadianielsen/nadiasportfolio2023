...
const Navigation = ({ showDropdown, setShowDropdown }) => {
    ...
    return (
        <>
            ...
            <nav className={` ${showDropdown ? "flex" : "hidden"} absolute top-0 h-screen left-0 bg-neutral-100/70 backdrop-blur-md w-screen py-4 flex-col gap-y-5 items-center justify-center md:bg-transparent md:static md:w-auto md:flex-row md:py-0 md:flex text-center md:gap-x-10 size770:h-0 shadow md:shadow-transparent`}>
