...
const Navigation = ({ showDropdown, setShowDropdown }) => {
    ...
    return (
        <>
            ...
            <nav className={` ${showDropdown ? "flex" : "hidden"} absolute top-full left-0 bg-white/30 backdrop-blur-sm md:backdrop-blur-0 w-screen py-4 flex-col gap-y-5 items-center md:bg-transparent md:static md:w-auto md:flex-row md:py-0 md:flex text-center md:gap-x-10 shadow md:shadow-transparent`}>
