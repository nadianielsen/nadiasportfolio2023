...
const WebsiteCard = ({ link, heading, img, text }) => {
   ...
   return (
      <div className="place-self-center w-full size300:w-[16rem] size600:w-[20.5rem] h-[12rem] md:h-[15rem] bg-black rounded-2xl relative website-card-shadow">
         ...
         <Link to={link} className="group hover:bg-black/40 w-full h-[30%] hover:h-full hover:transition-all hover:ease-in-out hover:duration-500 bg-neutral-100/80 backdrop-blur-sm bottom-0 absolute rounded-xl flex justify-center items-center">
