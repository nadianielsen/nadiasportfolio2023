...
const HomeGallery = () => {
    ...
    return (
        <article className="w-full">
            <motion.h1 initial="hidden" whileInView="visible" variants={senctence} className="text-[4rem] size700:text-[7rem] lg:text-[12rem] size1200:text-[14rem] size1400:text-[16rem] uppercase font-semibold text-center lg:relative lg:bottom-20 size1400:bottom-24">
            ...
            <section className=" lg:ml-16 size1400:ml-0 size1400:mr-40 flex flex-col lg:flex-row justify-center items-center">
                <img className="lg:relative lg:bottom-[12rem] size1400:bottom-[20rem] w-[15rem] lg:w-[20.5rem] border-2 border-black rounded-tr-[3rem] rounded-bl-[3rem]" src="./images/me copy.webp" alt="me - nadia nielsen" />
                <div className="lg:relative lg:bottom-[12rem] size1400:bottom-[16rem] py-12 px-16 size-1100:px-[25rem] size1400:py-32 flex flex-col">
