            ...
            <section className="mb-4 place-self-center">
                ...
                <section className="flex flex-col size800:flex-row justify-center items-center size800:items-start gap-x-20 gap-y-4">
                    <div>
                        ...
                        <p className="size800:w-[16rem] text-center size800:text-start w-[20rem]">For mit trykte produkt, valgte jeg at lave et magasin som indebærer info omkring UEFA WOMEN'S EURO 2025 og der ligger en trykklar pdf via knappen. </p>
