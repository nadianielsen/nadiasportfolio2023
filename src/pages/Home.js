...
const Home = () => {
    ...
    return (
        <motion.article initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 0.60}} className="grid z-50">
            ...
            <section className="flex justify-center items-center text-center h-[30vh]">
                <motion.p initial={{opacity: 0, x: -200}} whileInView={{opacity: 1, x:1}} transition={{ease: "easeInOut", delay: 0.30}} className="text-3xl">I am currently looking for <span className="text-[#00A5E7] crimson-font">apprenticeship (læreplads)</span></motion.p>
            </section>
            <section className="flex flex-col mt-20 size1100:mt-80">
