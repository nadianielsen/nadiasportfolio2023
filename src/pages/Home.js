    ...
    return (
        <motion.article initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 0.60}} className="grid gap-y-20 size1400:gap-y-0 z-50">
            ...
            <section className="flex justify-center items-center text-center h-[30vh]">
                <motion.p initial={{opacity: 0, x: -200}} whileInView={{opacity: 1, x:0}} transition={{ease: "easeInOut", delay: 0.30}} className="text-3xl size1560:text-4xl w-[70vw]">I am currently looking for <span className="text-[#00A5E7] crimson-font">apprenticeship (læreplads)</span></motion.p>
            </section>
