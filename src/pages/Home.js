...
const Home = () => {
    return (
        <article className="grid z-50">
            <div className="w-full h-[60vh] size400:h-screen flex justify-center items-center relative">
                ...
                <img src="./images/website banner copy.webp" alt="website banner" className="object-fill w-full h-screen " />
            </div>
