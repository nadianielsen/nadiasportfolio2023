    ...
    return (
        <motion.article initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 0.60}} className="grid gap-y-20 size1400:gap-y-0 z-50">
            ...
            <section className="flex flex-col mt-20 size1300:mt-80">
                ...
                <video src="Nadia Nielsen - Video portfolio.mp4" controls className="w-[80vw] md:w-[50vw] size1200:w-[40vw] shadow-md shadow-black/20 z-20 rounded-[2rem] bg-white place-self-center mb-32 object-cover" poster=""></video>
            </section>
        </motion.article>
    );
}
