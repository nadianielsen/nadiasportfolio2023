...
const Contact = () => {
    return ( 
        <article className="h-[65vh] sm:h-[80vh] md:h-[60vh] lg:h-[90vh] grid w-full md:flex md:flex-row md:items-center relative">
            ...
            <h2 className="uppercase text-3xl sm:text-5xl md:text-6xl lg:text-9xl m-auto md:m-0 px-10 md:pl-14 lg:pl-40 lg:w-[50%] font-light">Let's get <span className="lg:pl-32">in touch</span></h2>
