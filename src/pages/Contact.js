...
const Contact = () => {
    return (
        <article className="h-[60vh] sm:h-[80vh] md:h-[60vh] lg:h-[90vh] size1560:h-[70vh] flex flex-col justify-center items-center gap-y-10 w-full md:flex md:flex-row md:justify-normal md:items-center relative">
            <img src="./images/website contact - green.webp" alt="" className=" absolute object-fill w-full h-full -z-10 opacity-35" />
            <h2 className="uppercase text-4xl sm:text-5xl md:text-6xl lg:text-8xl size1100:text-9xl  md:m-0 px-10 md:pl-14 lg:pl-40 lg:w-[50%] font-light">Let's get in <motion.span className="relative text-[#7ea46c]" initial={{ opacity: 0}} animate={{opacity: 1}} transition={{delay: 0.30, duration: 0.60}} >touch</motion.span></h2>
            <article className="border-y-2 border-black w-[60%] sm:w-[35%] h-[20vh] md:h-[45vh] size1560:h-[30vh] grid grid-cols-1 grid-rows-4  md:m-0">
