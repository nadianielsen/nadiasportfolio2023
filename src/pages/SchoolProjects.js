            ...
            <article className="grid grid-cols-1 lg:grid-cols-2 size1470:grid-cols-3 justify-items-center w-[75%] m-auto my-10 gap-10">
                {projectsImg.map(({ img, headline, text }) => (
                   ...
                   <ContentWrapper content={ 
                        <div className="w-[20rem] h-[20rem] md:w-[22rem] lg:h-[30rem] group [perspective:1000px]">
                ...
                {/* <div className="w-[20rem] h-[20rem] md:w-[62rem] lg:h-[30rem] group [perspective:1000px] relative left-10">
                        <div className="relative h-full w-full transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                            <div className="absolute inset-0">
                                <img className="rounded-2xl w-full h-full object-cover" src={"/images/school/Banner - Afprøvning 2.jpg"} alt="headline" />
                            </div>
                            <div className="absolute inset-0 bg-black/60 w-full h-full flex flex-col justify-center items-center rounded-2xl [transform:rotateY(180deg)] [backface-visibility:hidden]">
                                <h1 className="text-white text-2xl font-semibold capitalize"></h1>
                                <p className="text-white text-lg text-center max-w-[16rem]"></p>
                            </div>
                        </div>
                    </div> */}
            </article>
