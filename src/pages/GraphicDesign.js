...
const GraphicDesign = () => {
    ...
    return (
        <>
            ...
            <article className="grid gap-y-20 mt-14 size1200:grid-cols-3 justify-items-center m-auto lg:w-[80%] lg:gap-x-20 size2000:gap-x-10 size2000:justify-items-start">
