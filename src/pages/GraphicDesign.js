...
const GraphicDesign = () => {
    ...
    return (
        ...
        <article className="grid gap-y-20 my-14 size1200:grid-cols-3 justify-items-center m-auto lg:w-[80%] lg:gap-x-20 ">
            ...
            <LinkCards bgGradient={"bg-gradient-to-b from-transparent via-transparent to-black/60"} url={"/posters"} subscription={"Here is my posters and wallpapers of influencer and celebrities, etc..."} heading={"Posters and wallpapers"} img={"./images/posters-wallpapers/Poster-Album cover - YOU - 27-10-2023.jpg"} alt={"Posters and Wallpapers - Page - Link"} />
        </article>
