...
const GraphicDesign = () => {
    ...
    return (
        <>
            ...
            <article className="grid gap-y-20 mt-14 size1200:grid-cols-3 justify-items-center m-auto lg:w-[80%] size1300:w-[70%] size1400:w-[50%] lg:gap-x-20 size2000:gap-x-10">
