...
const Design = () => {
    return ( 
        ...
        <article className="grid mx-20 gap-y-2.5 my-6">
            ...
            <p>Since I have been taking the web developer education, I then have a plan on taking the media graphic designer(mediegrafiker) education, since I love digital designing.</p>
            <p>I have used different apps for design, but my main graphic design app is procreate. In procreate you can both draw, animate, 3D design and graphic design and it's an app that is on ios only - iPad and iPhone.</p>
            ...
            <p>I am just starting out on Canva, trying to learn since it has become very popular these past few years.</p>
            <article>
