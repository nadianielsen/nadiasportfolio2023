...
const About = () => {
    ...
    const bgColor = ["bg-[#31A8FF]", "bg-[#f8a829]", "bg-[#E749A0]", "bg-black", "bg-[#f24e1e]", "bg-[#E298F2]", "bg-[#CF96FD]"]

    const bgColorCode = ["bg-orange-500", "bg-blue-400", "bg-yellow-400", "bg-[#61d9fb]", "bg-black", "bg-[#38bdf8]", "bg-[#477397]", "bg-pink-600"]
    ...
    return (
        ...
        // </article>
        <article className="">
            <article className="h-full pt-28 px-10 lg:p-40 flex flex-col-reverse xl:flex-row justify-center items-center lg:items-start gap-x-20 gap-y-6">
                <section className="md:w-[40rem] lg:[w-60rem] flex flex-col gap-y-2">
                    ...
                    <section className="flex flex-col gap-y-2">
                        ...
                        <h3 className="text-xl capitalize font-semibold text-[#7EA46C] mt-10">Languages, Framework & Libraries</h3>
                        ...
                        <div className="flex flex-wrap gap-3 mt-6 mb-4">
                            {["HTML", "CSS", "JavaScript", "React", "Next.JS", "Tailwindcss", "Wordpress", "SASS/SCSS"].map((skill, index) => (
                                <span key={skill} className={`text-white ${bgColorCode[index % bgColorCode.length]} px-4 py-2 rounded-full font-poppins text-sm font-medium`}>
                                    {skill}
                                </span>
                            ))}
                        </div>
