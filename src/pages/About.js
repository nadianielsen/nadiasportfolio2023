...
const About = () => {
    ...
    return (
    <article className="grid gap-y-20 my-14 lg:grid-cols-3 justify-items-center m-auto lg:w-[80%] lg:gap-x-20 lg:my-32">
        ...
        <LinkCards heading={"About Me"} subscription={"Information about me."} img={"./images/hero.jpg"} alt={"blurred colors"} url={"/aboutme"}/>
    </article>
    );
}
