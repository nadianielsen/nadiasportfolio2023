...
const About = () => {
    ...
    return (
        <>
            ...
            <article className="md:w-[70%] md:h-screen m-auto grid md:overflow-y-auto relative bg-white md:bg-neutral-100 p-2">
                ...
                <article className="md:mx-[5%] grid">
                    <article className="">
                        ...
                        <article className="flex gap-x-3 md:gap-x-5">
                            <p className="text-orange-600 drop-shadow md:text-xl">HTML</p>
                            <p className="text-blue-500 drop-shadow md:text-xl">CSS</p>
                            <p className="text-yellow-500 drop-shadow md:text-xl">JavaScript</p>
                            <p className="text-cyan-300 drop-shadow md:text-xl">React</p>
                            <p className="text-pink-400 drop-shadow md:text-xl">SCSS</p>
                            <p className="text-sky-500 drop-shadow md:text-xl">Tailwind CSS</p>
                            <p className="text-black drop-shadow md:text-xl">NEXT JS</p>
                            <p className="text-pink-400 drop-shadow md:text-xl">Styled Components</p>
                        </article>
                    </article>
                    <article>
                        <p>You can see most of it on my <Link to={"https://github.com/nadianielsen"} className="underline font-semibold hover:text-[#f03fa9] hover:underline transition-all">github</Link></p>
                    </article>
                    <article className="">
