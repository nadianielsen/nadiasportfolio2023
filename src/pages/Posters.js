...
const Posters = () => {
    ...
    return (
        <>
            ...
            <article className="grid grid-cols-1 md:grid-cols-2 size1470:grid-cols-3 justify-items-center w-[85%] size1200:w-[70%] size1470:w-[80%] size1700:w-[50%] m-auto my-14 size300:gap-x-20 gap-y-12">
