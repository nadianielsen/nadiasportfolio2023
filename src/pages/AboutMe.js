            ...
            <article className="mx-10 md:mx-20 my-6">
                <article className="flex flex-col gap-y-4 md:flex-row gap-x-10">
                    ...
                    <div className="flex flex-col gap-y-1.5">
                        ...
                        <p className="w-[80%]"><span className="font-semibold">I am currently taking the media graphic design education</span> and the reason why is that I am passionated about graphic/digtal design and I love to make color combinations, edit pictures, illustrations etc... </p>
