    ...
    return (
        <article className="grid gap-y-2">
            ...
            <section className="flex flex-col size800:flex-row justify-center gap-x-20 gap-y-5 place-self-center mb-4">
                <div className="">
                    <p className="w-[13rem]"><span className="font-semibold">Til mit første hovedforløb</span> har jeg valgt to produkter. Jeg har et trykt produkt som er en plakat og et digitalt produkt som er en video.</p>
                    <DownloadButton filepdf={""} downloadPDF={""} extraStyle={"my-4"} />
                </div>
